...
<body>
      ...
      <form class="form-signin" action="login.php" method="post" name="login">
        <h2 class="form-signin-heading"><div id="titulo">PLAN DE ESTUDIOS-DOCENTES</div></h2>
      
        <input type="text" class="input-block-level"  name="usudocente" id="usudocente" value="Usuario"  autofocus>
        <input type="password" class="input-block-level" name="passdocente"  id="passdocente" value="password">
        <label>
          <div> <?php
                if (isset($_GET["m"])) {
                  switch ($_GET["m"]) {
